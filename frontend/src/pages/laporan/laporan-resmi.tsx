...
interface LaporanResmi {
  ...
  kontrak: { kontrak_id: string; harga_per_porsi: number; porsi_per_hari: number } | null;
  penerima: Penerima[];
...
export function HalamanLaporanResmi() {
  ...
  const rencanaBiaya = rencanaBiayaOrangHari
    ...
    : (kontrak ? kontrak.harga_per_porsi * kontrak.porsi_per_hari : 0);
        ...
        <div className="flex flex-col gap-4 text-sm">
          ...
          <Card className="print:border-0 print:p-0 print:shadow-none">
            ...
            <TabelManual label="Rencana Biaya per Orang per Hari (Rp)" value={rencanaBiayaOrangHari} onChange={setRencanaBiayaOrangHari}
              placeholder={kontrak ? String(kontrak.harga_per_porsi * kontrak.porsi_per_hari) : ''}
              keterangan={kontrak ? `Auto dari kontrak: ${formatRupiah(kontrak.harga_per_porsi * kontrak.porsi_per_hari)}/hari` : 'Belum ada kontrak aktif'} />
          ...
          <Card className="overflow-x-auto print:border-0 print:p-0 print:shadow-none">
            ...
            <table className="w-full text-xs">
              ...
              <tbody>
                ...
                <tr className="border-b border-gray-100">
                  ...
                  <td className="py-1 pr-2 text-right">{kontrak ? formatRupiah(kontrak.harga_per_porsi * kontrak.porsi_per_hari) : '-'}</td>
                  <td className="py-1 text-right">…</td>
                </tr>
                <tr className="font-bold">
            ...
            <TabelAuto label="Besaran pendebetan per hari" nilai={kontrak ? formatRupiah(kontrak.harga_per_porsi * kontrak.porsi_per_hari) : '-'} />
